            ...
            <b-row class="justify-content-md-center">
                <b-col cols="4" class="border pt-3">
                    ...
                    <div class="pt-3">
                        ...
                        label-for="username"
                        >
                        <b-form-input id="username" v-model="username" trim placeholder="Username"></b-form-input>
                        </b-form-group>
                        <b-form-group
                        id="f-password"
                        label-for="password"
                        >
                        <b-form-input id="password" type="password" v-model="password" trim placeholder="Password"></b-form-input>
                        </b-form-group>
                        <b-form-group
                        id="f-username"
                        label-for="username"
